 ...
 *
 * @description
 * `<md-autocomplete>` is a special input components with a drop-down of all possible matches to a custom query.
 * This components allows you to provide real-time suggestions as the user types in the input area.
 *
 ...
 * parts that make up our components.
 *
...
"use strict";
   ...
   *    Warning: This components is a WORK IN PROGRESS. If you use it now,
...
"use strict";
   ...
   *    `md-autocomplete` element. The components allows the caller to supply a query expression
 ...
 * **Tabs with internal views** are the traditional usages where each tab has associated view content and the view switching is managed internally by the Tabs components.
